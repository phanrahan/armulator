...
extern ARMword GetWord (ARMul_State * state, ARMword address, int check);
extern void PutWord (ARMul_State * state, ARMword address, ARMword data, int check);
...
void ARMul_StoreHalfWord (ARMul_State * state, ARMword address, ARMword data)
{
    ...
    PutWord (state, address, (temp & ~(0xffffL << offset)) | ((data & 0xffffL) << offset), TRUE);
}
...
void ARMul_WriteByte (ARMul_State * state, ARMword address, ARMword data)
{
    ...
    PutWord (state, address, (temp & ~(0xffL << offset)) | ((data & 0xffL) << offset), TRUE);
}
...
ARMword ARMul_SafeReadByte (ARMul_State * state, ARMword address)
{
    ARMword temp, offset;
...
void ARMul_SafeWriteByte (ARMul_State * state, ARMword address, ARMword data)
{
    ARMword temp, offset;
    ...
    PutWord (state, address, (temp & ~(0xffL << offset)) | ((data & 0xffL) << offset), FALSE);
}
